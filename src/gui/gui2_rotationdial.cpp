...
: GuiElement(owner, id), min_value(min_value), max_value(max_value), func(func)
{
}
...
void GuiRotationDial::onDraw(sp::RenderTarget& renderer)
{
    ...
    renderer.drawRotatedSprite("gui/widget/dial_button.png", center, radius * 2.0f, (my_spaceship->manual_aim_angle - min_value) / (max_value - min_value) * 360.0f);
}
...
GuiRotationDial* GuiRotationDial::setValue(float value)
{
    ...
    my_spaceship->manual_aim_angle = value;
    return this;
}
